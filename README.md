...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/WaP3o3ozDBxkJcaAgr/only) 
...
|Vmess额外id（alterid）|0</br>默认启用AEAD</br>**注意：此选项将于2022.1.1之后废弃不用，请使用者及时更新最新的客户端以解决此问题。仅对使用X2的有影响。**|
|底层传输安全|tls|
|跳过证书验证|false|
